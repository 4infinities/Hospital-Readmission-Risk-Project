CREATE OR REPLACE TABLE hospital-readmission-4.helper_tables.helper_cost_aggregation_grouped as
WITH
  group_flags AS (
    SELECT
      id,
...
left join `hospital-readmission-4.helper_tables.helper_cost_aggregation` hc
